...
person:`Swami Vivekananda`
  ...
  {
    quote:`"Don not take rest after your first victory because if you fail in second, more lips are waiting to say that your first victory was just luck."`,
      ...
      person:`Rabindranath Tagore`
        },
        {
          ...
          person:`Sardar Vallabhbhai Patel`
            ...
            {
                quote:` "Success often comes to those who dare to act. It seldom goes to the timid who are ever afraid of the consequences."`,
              person:`Jawaharlal Nehru`
                },
                {
                    quote:` "Every tiny molecule of Ash is in motion with my heat I am such a Lunatic that I am free even in Jail."`,
                  person:`Bhagat Singh`
                    },
                    {
